...
set_property PACKAGE_PIN J11   [get_ports {CLK_A_LOL_N}];
# set_property PACKAGE_PIN H12   [get_ports {CLKB_FDEC}];
# set_property PACKAGE_PIN G11   [get_ports {CLKB_FINC}];
set_property PACKAGE_PIN J10   [get_ports {CLK_B_LOL_N}];
set_property IOSTANDARD LVCMOS33 [get_ports {CLK_*_LOL_N}];
...
set_property PACKAGE_PIN F1   [get_ports {L2_MSH_GBT_RX_N}];
set_property PACKAGE_PIN F2   [get_ports {L2_MSH_GBT_RX_P}];
set_property PACKAGE_PIN E3   [get_ports {L2_MSH_GBT_TX_N}];
set_property PACKAGE_PIN E4   [get_ports {L2_MSH_GBT_TX_P}];
...
set_property PACKAGE_PIN H1   [get_ports {L4_MSH_GBT_RX_N}];
set_property PACKAGE_PIN H2   [get_ports {L4_MSH_GBT_RX_P}];
set_property PACKAGE_PIN H5   [get_ports {L4_MSH_GBT_TX_N}];
set_property PACKAGE_PIN H6   [get_ports {L4_MSH_GBT_TX_P}];
...
set_property IOSTANDARD LVCMOS33 [get_ports {ME_FPI_LED_*}];
...
set_property IOSTANDARD LVCMOS18 [get_ports {RIO_*}]
