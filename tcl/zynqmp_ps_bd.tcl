...
################################################################
# This is a generated script based on design: CPSI_CIO
#
...
proc create_root_design { parentCell } {
  ...
  set axi_m00 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 axi_m00 ]
  ...
  # Create ports
  set aux_rstb_in [ create_bd_port -dir I -type rst aux_rstb_in ]
  set axi_aclk [ create_bd_port -dir O axi_aclk ]
  set axi_iconn_aresetn [ create_bd_port -dir O -from 0 -to 0 -type rst axi_iconn_aresetn ]
  set axi_peripheral_aresetn [ create_bd_port -dir O -from 0 -to 0 -type rst axi_peripheral_aresetn ]
  set axi_peripheral_reset [ create_bd_port -dir O -from 0 -to 0 -type rst axi_peripheral_reset ]
  set dcm_locked [ create_bd_port -dir I dcm_locked ]
  set mb_debug_sys_rst_in [ create_bd_port -dir I mb_debug_sys_rst_in ]
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#I2C 0#I2C 0#GPIO0 MIO#SD 0#SD 0#SD\
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB1 Reset#GPIO0 MIO#GPIO0 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#PCIE#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#UART 0#UART 0#GPIO1\
...
1#USB 1#USB 1#USB 1##} \
    CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#gpio0[6]#gpio0[7]#gpio0[8]#gpio0[9]#scl_out#sda_out#gpio0[12]#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#reset#gpio0[24]#gpio0[25]#gpio1[26]#gpio1[27]#gpio1[28]#gpio1[29]#reset_n#gpio1[31]#gpio1[32]#gpio1[33]#gpio1[34]#gpio1[35]#gpio1[36]#gpio1[37]#rxd#txd#gpio1[40]#gpio1[41]#gpio1[42]#gpio1[43]#gpio1[44]#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]##}\
\
    ...
    CONFIG.PSU__GEM3__REF_CLK_SEL {Ref Clk1} \
...
\
    ...
    CONFIG.PSU__USB1__RESET__IO {MIO 23} \
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_ports axi_m00] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net aux_rstb_in_1 [get_bd_ports aux_rstb_in] [get_bd_pins proc_sys_reset_0/aux_reset_in]
  connect_bd_net -net dcm_locked_1 [get_bd_ports dcm_locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net mb_debug_sys_rst_in_1 [get_bd_ports mb_debug_sys_rst_in] [get_bd_pins proc_sys_reset_0/mb_debug_sys_rst]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_ports axi_iconn_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_ports axi_peripheral_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_ports axi_peripheral_reset] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_ports axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_m00/Reg] -force
